...
export function ProfileTabs({
  ...
  return (
    <section className="mt-8">
      <div className={`flex flex-wrap gap-2 ${themeUi.segmentNav}`}>
        {tabs.map((tab) => {
          const Icon = tab.icon;
          return (
            <button
              ...
              className={cn(
                "inline-flex items-center gap-2 px-4 py-2 text-sm transition min-h-11",
                active === tab.id ? themeUi.tabActive : themeUi.tabInactive,
              )}
            >
