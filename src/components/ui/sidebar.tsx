...
const SIDEBAR_WIDTH_MOBILE = "min(19rem, 88vw)";
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] border-r border-cyan-400/10 bg-sidebar p-0 text-sidebar-foreground shadow-2xl shadow-black/40 [&>button]:hidden"
            style={{ "--sidebar-width": SIDEBAR_WIDTH_MOBILE } as React.CSSProperties}
            side={side}
          >
            <SheetHeader className="sr-only">
              <SheetTitle>Menu de navegação</SheetTitle>
              <SheetDescription>Navegação principal do Hexavante</SheetDescription>
            </SheetHeader>
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(
  ({ className, ...props }, ref) => (
    <main ref={ref} className={cn("hx-sidebar-inset", className)} {...props} />
  ),
);
