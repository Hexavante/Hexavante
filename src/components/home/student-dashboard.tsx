...
import { ArrowRight, Award, BarChart3, BookOpen, Sparkles, Target, Trophy } from "lucide-react";
    ...
    <Card padding="md" className="shadow-2xl shadow-black/30 backdrop-blur">
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-3">
        ...
        <div className="rounded-lg border border-[hsl(var(--sidebar-border))] bg-[var(--surface)] p-3">
          ...
          <Link
            href="/ranking"
            className="mt-1 inline-flex items-center gap-1 text-sm font-semibold hx-accent-link"
          >
        ...
        <div className="mt-5 space-y-2">
          ...
          {inProgress.map((enrollment) => (
            <Link
              ...
              className="flex items-center justify-between rounded-lg border border-[hsl(var(--sidebar-border))] bg-[var(--surface)] px-3 py-2.5 transition hover:border-[hsl(var(--sidebar-highlight)/0.3)] hover:bg-[hsl(var(--sidebar-highlight)/0.06)]"
            >
      ...
      <div className="mt-5 flex flex-wrap gap-2 border-t border-white/10 pt-4">
        ...
        <LinkButton href="/estatisticas" variant="outline" size="sm">
