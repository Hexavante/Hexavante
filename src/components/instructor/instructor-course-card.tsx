...
export function InstructorCourseCard({
  ...
  return (
    <Link
      ...
      className="group overflow-hidden rounded-xl border border-[hsl(var(--sidebar-border))] bg-[var(--surface)] transition hover:border-[hsl(var(--sidebar-highlight)/0.35)] hover:bg-[var(--surface-strong)]"
    ...
    >
      ...
      <div className="p-4">
        <div className="flex flex-wrap items-center gap-2">
          <h3 className="font-semibold text-white transition group-hover:text-[hsl(var(--sidebar-highlight)/0.9)]">{title}</h3>
        ...
        <p className="mt-3 text-sm hx-accent-link">Editar curso →</p>
      </div>
    </Link>
  );
}
