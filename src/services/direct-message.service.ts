...
function getOtherParticipant(
  conversation: {
    ...
    participantA: { id: string; username: string | null; fullName: string; avatarUrl: string | null };
    participantB: { id: string; username: string | null; fullName: string; avatarUrl: string | null };
  },
  userId: string,
) {
